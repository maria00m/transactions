...
import "./App.css";
import logo from "./imgs/jumia.png";
  ...
  return (
    <div className="App">
        ...
        <div className="nav-list">
          ...
          <div className="nav-item">
            ...
            <ul className="dropdown-list">
              <li style={{ backgroundColor: "#020024" }}>Transaction List</li>
      ...
      <div className="main-content">
        {/* tracking */}
        <header>
          <p>Transactions {">"} Transaction List</p>
        </header>
        ...
        {Loading ? (
          ...
          <div className="details">
            ...
            <div className="search-card">
              <div className="card">
                <p>Search By Customar Name</p>
                <input
                  placeholder="ex: Mariam Gerges"
            ...
            <div className="search-card">
              <div className="table-container">
                <h1 className="title">Transactions conclusion</h1>
